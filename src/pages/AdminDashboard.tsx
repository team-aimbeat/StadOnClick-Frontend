              ...
              <div className="space-y-6 rounded-[28px]   bg-white p-6">
                ...
                <div>
                  ...
                  <div className="mt-4 flex items-center gap-4 text-sm text-slate-700">
                    ...
                    <button className="rounded-full border border-slate-200 px-4 py-1 text-xs font-medium text-slate-600">
                      View all →
                    </button>
                  </div>
                </div>
          ...
          {/* <div className="space-y-6">
            ...
            <div className="rounded-[28px]  bg-white p-6">
              <div className="flex items-center gap-6 border-b border-slate-100 pb-4">
                <button className="text-sm font-semibold text-slate-900 border-b-2 border-slate-900 pb-2">
                  Comments
                </button>
              </div>
              <div className="mt-4 space-y-4">
