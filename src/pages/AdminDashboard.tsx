...
import CalendarAgendaCard from '@/components/AdminDashboard/CalendarAgendaCard';
...
const AdminDashboard: React.FC = () => {
  ...
  const quickMetrics = [
    ...
    { title: 'Active vel today', value: 3812, percentage: 50, trend: 'down', icon: HiOutlineChartBar, accentColor: 'purple', subtitle: 'Active Visits Today', avatars: sampleAvatars },
    { title: 'Active customers today', value: 132, percentage: 132, trend: 'up', icon: HiOutlineUserGroup, accentColor: 'green', subtitle: 'Active Customers Today', avatars: sampleAvatars },
    { title: 'Active users today', value: 132, percentage: 132, trend: 'down', icon: HiOutlineUserGroup, accentColor: 'yellow', subtitle: 'Active Users Today', avatars: sampleAvatars },
    { title: 'New users today', value: 132, percentage: 120, trend: 'up', icon: HiOutlineUser, accentColor: 'red', subtitle: 'New Users Today', avatars: sampleAvatars },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto w-full space-y-6 px-4 lg:px-2">
        <div className="rounded-[28px] w-[300px]  bg-white p-5">
          <Breadcrumb />
        </div>
          ...
          <div className="space-y-6">
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-3xl  bg-slate-50/70 p-5">
                  <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Customers</p>
                  <div className="mt-2 flex items-center justify-between">
                    <div>
                      <p className="text-4xl font-semibold text-blue-800">1,293</p>
                ...
                <div className="rounded-3xl  bg-slate-50/70 p-5">
                  ...
                  <div className="mt-2 flex items-center justify-between">
                    <div>
                      <p className="text-4xl font-semibold text-blue-800">256k</p>
                      <p className="text-sm text-slate-500">vs last month</p>
                    </div>
...
<div className='grid grid-cols-1  lg:grid-cols-2'>     <RecentActivities title="Recent activities" activities={recentActivities} />
</div>
            ...
            <div className="rounded-[28px]  bg-white p-6">
              ...
              <div className="mt-4 space-y-4">
                {comments.map((comment) => (
                  <div key={comment.id} className="flex gap-4 rounded-2xl  p-4">
