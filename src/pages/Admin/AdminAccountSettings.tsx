...
const AdminAccountSettings = () => {
  ...
  const [initialPersonalForm, setInitialPersonalForm] =
    React.useState(personalForm);
  ...
  React.useEffect(() => {
    const stored = localStorage.getItem("admin-settings-preferences");
    if (stored) {
      try {
  ...
  return (
    <DashboardContainer className="space-y-8 pb-14">
      <TitleBreadCrumbs
        ...
        breadCrumbTitle="Admin / Account Settings"
        className="w-full"
      />
            ...
            <div className="rounded-[28px] border border-slate-100 bg-white p-5 shadow-[0_18px_50px_-40px_rgba(15,23,42,0.22)]">
              <div className="mx-auto flex max-w-[190px] flex-col items-center rounded-[24px] bg-white px-4 py-4 text-center shadow-sm">
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="absolute -right-2 bottom-0 flex h-8 w-8 items-center justify-center rounded-full bg-[#4F7DFF]  text-white shadow-lg"
                    onClick={() =>
                      document.getElementById("admin-avatar")?.click()
                    }
                ...
                <p className="text-xs text-slate-500">
                  {profileRole} • ID: {profile?.id || "88219"}
                </p>
          ...
          <main className="flex-1 space-y-5">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-slate-500">
                  Manage your business profile, security protocols, and platform
                  preferences.
                </p>
              </div>
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {[
                {
                  title: "Team Access",
                  body: "4 active users with management permissions.",
                },
                {
                  title: "Audit Logs",
                  body: "Review account activity from the last 90 days.",
                },
                {
                  title: "Region",
                  body: "Operating from London (GMT+0) - Global reach.",
                },
              ].map((item) => (
                <div
                  key={item.title}
                  className="rounded-[22px] border border-slate-100 bg-white p-5 shadow-[0_18px_50px_-40px_rgba(15,23,42,0.18)]"
                >
                ...
                {activeSection === "security" ? (
                  <div className="space-y-6">
                    <div className="rounded-2xl border border-amber-100 bg-amber-50 p-4 text-sm text-amber-800">
                      Strong passwords help keep your booking and payout data
                      safe.
                    </div>
                        ...
                        <div className="space-y-1" key={field}>
                          ...
                          <div className="relative">
                            <Input
                              ...
                              value={
                                passwordForm[field as keyof typeof passwordForm]
                              }
                              className="pr-12"
                              onChange={(event) =>
                ...
                {activeSection === "preferences" ? (
                  <div className="space-y-6">
                    <div className="grid gap-6 md:grid-cols-2">
                      ...
                      <div className="space-y-1">
                        <Label htmlFor="admin-timezone">Time zone</Label>
                      ...
                      {[
                        {
                          ...
                          description:
                            "Release notes, improvements, and new admin tools.",
                          icon: Timer,
                        },
                        {
                          key: "marketingEmails",
