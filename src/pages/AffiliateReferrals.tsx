...
import { useGetAffiliateReferralsQuery } from "@/features/affiliate/api/affiliateApi";
...
export default function AffiliateReferrals() {
  ...
  const { data: referralsRes, isLoading } = useGetAffiliateReferralsQuery(
    { page, limit },
    {
  ...
  if (isLoading) {
    return <div className="p-8">Loading referrals...</div>;
  }

  return (
    <DashboardContainer className="space-y-6 pb-8">
      <TitleBreadCrumbs title="Referrals" breadCrumbTitle="Affiliate / Referrals" />
