      ...
      >
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <div className="dropdown">
              <Dropdown
                ...
                button={<IconDots className="opacity-70" />}
              >
                <ul className="whitespace-nowrap">
                  ...
                  <li>
                    <button type="button">
                      <IconLogout className="w-4.5 h-4.5 ltr:mr-1 rtl:ml-1 shrink-0" />
                      Sign Out
                    </button>
                  </li>
                </ul>
          ...
          <div className="relative">
            <input
              type="text"
              className="form-input peer ltr:pr-9 border-2 border-secondary-yellow rtl:pl-9"
                ...
                <div className="flex sm:gap-5 gap-3">
                  <div className="dropdown">
                    <Dropdown
                      ...
                      button={
                        <IconDotsVertical className="hover:text-primary opacity-70" />
                      }
                    >
                      <ul className="text-black dark:text-white-dark">
                        ...
                        <li>
                          <button type="button">
                            <IconTrash className="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" />
                            Delete
                          </button>
                        </li>
                        <li>
