...
const RevenueRowSkeleton = () => (
  <div className="grid grid-cols-[1.4fr_140px_160px_140px] items-center gap-4 px-6 py-5">
    ...
    <DashboardContainer className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        {Array.from({ length: 3 }).map((_, index) => (
          <TreasuryStatSkeleton key={index} />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.35fr_0.95fr]">
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6">
          ...
          <Skeleton className="mt-3 h-12 w-44 bg-slate-100" />
        ...
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6">
          ...
          <div className="mt-5 overflow-hidden rounded-2xl border border-slate-200">
            <div className="grid grid-cols-3 gap-3 border-b border-slate-200 bg-slate-50 px-4 py-3">
              <Skeleton className="h-3 w-14 bg-slate-200" />
              <Skeleton className="h-3 w-20 bg-slate-200" />
              <Skeleton className="ml-auto h-3 w-16 bg-slate-200" />
            </div>
            {Array.from({ length: 4 }).map((_, index) => (
              <div key={index} className="grid grid-cols-3 gap-3 border-b border-slate-100 px-4 py-4 last:border-b-0">
                <Skeleton className="h-4 w-24 bg-slate-100" />
                <Skeleton className="h-4 w-20 bg-slate-100" />
                <Skeleton className="ml-auto h-4 w-16 bg-slate-100" />
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white">
        ...
        <div className="grid grid-cols-[1.4fr_140px_160px_140px] gap-4 border-b border-slate-200 bg-slate-50 px-6 py-4">
